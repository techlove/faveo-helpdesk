...
return [
    ...
    'alert'                                                          => 'Notis',
    'warning'                                                        => 'Varning',
    'required-error'                                                 => 'Var god fyll i alla obligatoriska fält',
    'invalid'                                                        => 'Felaktigt användar-ID eller lösenord',
    'sorry_something_went_wrong'                                     => 'Något gick fel',
    'were_working_on_it_and_well_get_it_fixed_as_soon_as_we_can'     => "Vi arbetar på att åtgärda detta snarast möjligt.",
    'we_are_sorry_but_the_page_you_are_looking_for_can_not_be_found' => 'Sidan du försökte nå existerar inte.',
    'go_back'                                                        => 'Gå tillbaka',
    'the_board_is_offline'                                           => 'Brädan är offline',
    'error_establishing_connection_to_database'                      => 'Fel vid uppkoppling till databas',
    'unauthorized_access'                                            => 'Åtkomst nekad',
    'not-autherised'                                                 => 'Du är inte autentiserad för att visa denna sida.',
    'otp-not-matched'                                                => 'Ojdå! Engångskoden du angav är felaktig.',
    'otp-invalid'                                                    => 'Engångskoden är sex tecken lång.',
    'otp-input-title'                                                => 'Ange den sex tecken långa engångskoden.',
    'otp-expired'                                                    => 'Din engångskod har utgått.<br/> Klcka på "Skicka ny engångskod" för att få en ny kod.',
    'resend-otp-title'                                               => 'Klicka här för att skicka en ny engångskod.',
    /*
      |--------------------------------------
      |   Login Page
      |--------------------------------------
